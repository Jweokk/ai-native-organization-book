...
**Read online**: [GitHub repository](https://github.com/Jweokk/ai-native-organization-book) (browse the `book-en/` folder, or read each chapter via the links below) · **Download PDF**: [ai-native-organization-en.pdf](ai-native-organization-en.pdf)
...
- [Preface](book-en/00-preface.md) — why this book exists, and how it writes itself
- [Chapter 1](book-en/01-ch1-the-rise-of-ai-native-organizations.md) — The rise of AI-native organizations: starting from the 95% failure rate
- [Chapter 2](book-en/02-ch2-what-is-an-ai-native-organization.md) — What is an AI-native organization: band-aid AI vs AI-native DNA
- [Chapter 3](book-en/03-ch3-the-evidence.md) — The evidence: what empirical research says
- [Chapter 4](book-en/04-ch4-rebuilding-organizational-structure.md) — Rebuilding organizational structure: from hierarchy to network
- [Chapter 5](book-en/05-ch5-redesigning-workflows-and-decisions.md) — Redesigning workflows and decisions
- [Chapter 6](book-en/06-ch6-incentives-and-talent.md) — Incentives and talent
