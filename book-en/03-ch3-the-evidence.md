...
**McKinsey, *State of AI 2025* (November 2025)**: 88% of organizations regularly use AI in at least **one business function** (78% last year); but about two-thirds are still in the experiment/pilot stage and only about one-third have begun scaling; only 39% attribute any degree of EBIT impact to AI, and most of them say the contribution is under 5%; "AI high performers" (EBIT impact ≥5%) account for only about 6%. **Many companies use AI; very few make money from it.**
