...
**UK Department for Business and Trade Copilot pilot (officially published)**: 1,000 licenses were rolled out over three months, producing an average of just 1.14 Copilot actions per user per day. PowerPoint decks came out 7 minutes faster (18 down to 11 minutes) but at half the quality score; Excel analysis was actually completed more slowly and at lower quality; email time savings were, in its own words, "extremely small." The official conclusion, verbatim: **"We did not find robust evidence to suggest that time savings are leading to improved productivity." And yet 72% of users said they were satisfied or very satisfied**<sup><a href="12-appendix-a-sources.md#8-89">[8-89]</a></sup> — satisfaction decoupled from output, the cleanest controlled demonstration that individual gains do not equal organizational gains.

**Faros AI telemetry across 22,000 developers (2025)**: after AI adoption, individual throughput did rise, but in the same period median time in PR review increased by 441%, bugs per developer rose 54%, and incidents per PR rose 242%<sup><a href="12-appendix-a-sources.md#8-90">[8-90]</a></sup>. McKinsey's comparison is blunter: when developers do not adequately verify AI-generated code, bug density in those projects runs 23% higher than in projects where human oversight is maintained<sup><a href="12-appendix-a-sources.md#8-90">[8-90]</a></sup>. **Output went up, system quality went down — teams watching only speed metrics never see it.**

**NBER Working Paper w35559, "Replaceable but Employed" (Joshua Gans, 2026)**: automation can harm workers without displacing them. In the model, workers value both producing useful outcomes and the meaning that comes from the outcome depending on their own contribution; a credible machine substitute erodes the second source even if the firm keeps the worker. With fully adjusting wages the meaning loss is capitalized into compensation; with incomplete adjustment the worker bears part of it. And a "meaning externality" makes automation more likely, so profitable development can be socially harmful<sup><a href="12-appendix-a-sources.md#1-37">[1-37]</a></sup>. **The conclusion in one line: automation can reduce the value of work before it eliminates the job.**
**iResearch (Chinese: 艾瑞咨询), *Enterprise AI Agent Adoption: From "Shallow Prosperity" to a Value Loop* (August 2026, via 36Kr)**: in Q1 2026, AI adoption among large and mid-sized Chinese enterprises reached 90.9%, with 81.3% adoption for next-generation AI — yet 67.3% of companies remain at L1 (exploratory/pilot), 24.0% at L2 (localized enablement), and only 9.1% have reached L3 (systematic optimization), with L4 and L5 at zero. Project composition is even more telling: general-assistance scenarios account for 83.7% of enterprise agent projects against just 16.3% for deep professional scenarios, and roughly 30-40% of enterprise agent projects may stall or be shut down within 18 months because the expected ROI never materializes<sup><a href="12-appendix-a-sources.md#1-39">[1-39]</a></sup>. The value of the dataset is that it splits "adoption" and "maturity" into two separate rulers: **adoption measures what the organization bought; maturity measures what the organization changed — for large Chinese enterprises in 2026 the former is near saturation while the latter is still under one in ten.**
