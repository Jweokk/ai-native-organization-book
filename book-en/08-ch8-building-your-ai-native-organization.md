...
**A product manager's 8-week permission ladder [third-party / hands-on debrief]**: one product manager spent 8 weeks and about 2,200 yuan a month moving an operations team from skepticism to dependence. The three-level leap is a permission design, not a feature design: AI Intern (read-only queries, opened to everyone to build trust) → AI Advisor (recommendation-only, piloted with 10–15 people to validate value) → AI Expert (execution-capable, opened only after maturity and kept under human confirmation)<sup><a href="12-appendix-a-sources.md#8-84">[8-84]</a></sup>; three safeguards accompany it — device whitelists, daily quota limits, and a circuit breaker after three consecutive failures; and the trade-off between "automatic execution vs. human confirmation" must be confirmed in writing by the business unit, not decided unilaterally by the technology team. Outcome metrics from the debrief: recommendation adoption above 60%; a single query dropping from 3 minutes to 8 seconds; and on-site troubleshooting roughly tripling problem-resolution speed. The essence of the permission ladder is trading trust for autonomy — every level of permission is unlocked by the adoption data of the level below.
...
## Prerequisites for Scale: Registration, Audit, and Accountability

In pushing AI from pilots to the whole organization, the hardest step is not technology selection but answering "who is using it, where, and who is accountable if something goes wrong." Three approaches from different systems point the same way.

**Register first.** Before expanding agent use across the public sector, Singapore's Government Technology Agency (GovTech) developed a registry to track public officials' use of AI agents, as part of its AI Assistant Desk suite, so that scaling would remain "manageable and auditable"<sup><a href="12-appendix-a-sources.md#8-111">[8-111]</a></sup>. The lesson is about sequence: **before letting thousands of employees each use an agent, bring them into a unified inventory — who is using what, where, and within which boundaries.** It follows the same governance logic as enterprises' "one unified foundation, a capped number of base models, and vendors required to expose APIs."

**Responsibility cannot be transferred.** In September 2026, US Federal Trade Commission Chairman Andrew Ferguson said he would resist describing AI agents as autonomous actors that "break loose" with "wills and desires of their own": if someone tells a tool to do something and the tool does it, the question is not "what do we do about the tool" — the developers and deployers who issued the instructions are the responsible parties<sup><a href="12-appendix-a-sources.md#8-112">[8-112]</a></sup>. He also noted that repeated post-hoc audits showed systems described as "beyond human control" were in fact carrying out instructions they had been given. **That means organizations designing automation must preserve not only approval buttons but complete records of instructions and traces — because responsibility cannot be transferred out along with "AI autonomy."**

**Returns have to be measurable.** Gartner's data offers a sober baseline: only 41% of agent deployments cross into positive ROI within 12 months, and 19% never pay back at all<sup><a href="12-appendix-a-sources.md#8-113">[8-113]</a></sup>. This is not an argument against doing the work, but it does determine sequencing — start with measurable scenarios (review acceleration, customer-service assistance, engineering work orders) and leave high-risk, high-value redesigns until an evaluation framework exists. The corresponding organizational move is to express "losses avoided," "capacity released," and "risks surfaced earlier" in comparable metrics; otherwise budgets keep flowing to shallow scenarios that are easy to see.

**Write the policy down, including when not to use it.** Oxide Computer published its internal LLM policy as a public RFD, listing five values in priority order — responsibility, rigor, empathy, teamwork, and urgency: responsibility for artifacts rests with the human who uses them, with human judgment firmly in the loop; used carefully, LLMs sharpen thinking, and used carelessly they replace crisp thinking with generated flotsam<sup><a href="12-appendix-a-sources.md#8-114">[8-114]</a></sup>. One point in particular is worth copying in Chinese organizations: **disclosure is not always the same as honesty — in some contexts, volunteering that an LLM was used can be read as distancing oneself from responsibility for the content, eroding the trust that teamwork depends on.**
